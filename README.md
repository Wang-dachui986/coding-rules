...
本仓库只包含通用项目开发治理规则和空白模板，不包含任何具体项目源码、
服务器配置、节点参数、凭据或运行证据。
...
context recovery, evidence rules, and durable handoffs. It contains generic
governance templates only and does not include product code or project secrets.
